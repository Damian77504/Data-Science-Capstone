...
Predict <- function(x) {
        ...
        # Predict algorithm for the next term of the user input sentence
        # 1. For prediction of the next word, Quadgram is the first used (first three words of Quadgram are the last three words of the user provided sentence).
